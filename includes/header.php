            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-user fa-fw"></i> Projetos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href=""><i class="fa fa-edit fa-fw"></i> Tarefas<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                            ...
                            <?php
                                ...
                                echo '
                                <li>
                                    <a href="cadastrartarefa.php ">Criar Tarefa</a>
                                </li>
                                <li>
                                    <a href="">Alterar Tarefas</a>
                                </li>';
                            }
                                
                            ?>
                                <li>
                                    <a href="listartarefas.php">Listar Tarefas</a>
                                </li>
                            </ul>
                        </li>
                        </li>
